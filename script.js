...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let timeline = new TimelineMax(); //The scroll timeline allows us to map the scroll distance to the animation progress. TimelineMax is a type of timeline that allows you a lot of control over how things happen
    ...
    let scene = new ScrollMagic.Scene({
        ...
        duration: '200%', // Measured in screen size/pixels
